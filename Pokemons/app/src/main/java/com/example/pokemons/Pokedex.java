...
public class Pokedex
{
    ...
    List<String> getPokemons(String pokemonType1, String pokemonType2){
        List<String> pokemonList = new ArrayList<String>();
        for (int i = 0; i < pokemonData.length; i++) {
            if ((pokemonData[i][2].equals(pokemonType1) && pokemonData[i][3].equals(pokemonType2))||
                    (pokemonData[i][2].equals(pokemonType1) && pokemonType2.equals("-"))||
                    (pokemonType1.equals("-") && pokemonData[i][3].equals(pokemonType2))||
                    (pokemonType1.equals("-") && pokemonType2.equals("-"))){
                pokemonList.add("#"+pokemonData[i][0]+" "+pokemonData[i][1]);
            }
        }
